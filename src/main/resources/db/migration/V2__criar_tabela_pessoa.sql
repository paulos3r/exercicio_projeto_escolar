CREATE TABLE pessoa (
    ...
    nome VARCHAR(100) NOT NULL COMMENT 'Nome completo da pessoa, não pode ser nulo',
    ...
    endereco VARCHAR(255) COMMENT 'Endereço completo da pessoa (opcional, se não for sempre obrigatório)',
    telefone VARCHAR(15) COMMENT 'Número de telefone da pessoa (formato flexível, ex: (XX) XXXXX-XXXX)',
